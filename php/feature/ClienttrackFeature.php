...
// FederalRegister SDK clienttrack feature
...
class FederalRegisterClienttrackFeature extends FederalRegisterBaseFeature
{
    ...
    public function PostConstruct(FederalRegisterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FederalRegister-SDK';
