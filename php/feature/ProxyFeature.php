...
// FederalRegister SDK proxy feature
...
class FederalRegisterProxyFeature extends FederalRegisterBaseFeature
{
    ...
    public function init(FederalRegisterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FederalRegisterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
