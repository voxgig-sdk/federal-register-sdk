...
// FederalRegister SDK timeout feature
...
class FederalRegisterTimeoutFeature extends FederalRegisterBaseFeature
{
    ...
    private function _with_timeout(FederalRegisterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FederalRegisterContext $_ctx, float $ms): void
    {
        $client = $this->client;
