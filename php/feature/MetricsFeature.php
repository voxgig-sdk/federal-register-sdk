...
// FederalRegister SDK metrics feature
...
class FederalRegisterMetricsFeature extends FederalRegisterBaseFeature
{
    ...
    private function _record(FederalRegisterContext $ctx, bool $ok): void
    {
