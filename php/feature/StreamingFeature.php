...
// FederalRegister SDK streaming feature
...
class FederalRegisterStreamingFeature extends FederalRegisterBaseFeature
{
    ...
    private function _iterate(FederalRegisterResult $result): \Generator
    {
    ...
    private function _streamable(FederalRegisterContext $ctx): bool
    {
