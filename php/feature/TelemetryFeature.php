...
// FederalRegister SDK telemetry feature
...
class FederalRegisterTelemetryFeature extends FederalRegisterBaseFeature
{
    ...
    private function _close(FederalRegisterContext $ctx, bool $ok): void
    {
