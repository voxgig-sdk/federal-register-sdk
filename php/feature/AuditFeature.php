...
// FederalRegister SDK audit feature
...
class FederalRegisterAuditFeature extends FederalRegisterBaseFeature
{
    ...
    private function _emit(FederalRegisterContext $ctx, string $outcome): void
    {
