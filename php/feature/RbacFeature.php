...
// FederalRegister SDK rbac feature
...
class FederalRegisterRbacFeature extends FederalRegisterBaseFeature
{
    ...
    private function _required(FederalRegisterContext $ctx): ?string
    {
    ...
    private function _reject(FederalRegisterContext $ctx, string $required): void
    {
    ...
    private function _track(FederalRegisterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
