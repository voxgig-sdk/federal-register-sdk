...
print_r(array_map(fn($item) => $item->data_get(), $document));
```
...
```
php/
├── federalregister_sdk.php          -- Main SDK class
...
The main class (`federalregister_sdk.php`) exports the SDK class
