...
// FederalRegister SDK utility: graphql
//
...
class FederalRegisterGraphql
{
    ...
    // equivalent.
    public static function body(FederalRegisterContext $ctx): mixed
    {
    ...
    public static function errors(FederalRegisterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
