...
// FederalRegister SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FederalRegisterTransformResponse
{
    public static function call(FederalRegisterContext $ctx): mixed
    {
        ...
        $transform = FederalRegisterHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
