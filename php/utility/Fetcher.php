...
// FederalRegister SDK utility: fetcher
...
class FederalRegisterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FederalRegisterSDK/1.0)';
    ...
    public static function call(FederalRegisterContext $ctx, string $fullurl, array $fetchdef): array
    {
