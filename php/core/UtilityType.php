...
// FederalRegister SDK utility type

class FederalRegisterUtility
{
    ...
    public static function copy(FederalRegisterUtility $src): FederalRegisterUtility
    {
        $u = new FederalRegisterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
