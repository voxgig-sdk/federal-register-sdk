...
class FederalRegisterTestRunner
{
    ...
    {
        $live = self::getenv('FEDERAL_REGISTER_TEST_LIVE');
        $override = self::getenv('FEDERAL_REGISTER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FEDERAL_REGISTER_TEST_EXPLAIN');
...
class_alias('FederalRegisterTestRunner', 'Runner');
class_alias('FederalRegisterHelpers', 'Helpers');
