...
// FederalRegister SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FederalRegisterSDK::test)
...
{
    private const SDK_CLASS = 'FederalRegisterSDK';
    ...
    private const SDK_BASE = 'federalregister_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../federalregister_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
