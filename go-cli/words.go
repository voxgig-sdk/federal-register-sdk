...
func registerSDKWords(r *eng.Registry, client *sdk.FederalRegisterSDK) {
...
func runOp(client *sdk.FederalRegisterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
