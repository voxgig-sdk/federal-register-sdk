...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Document()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/federal-register-sdk/releases)) or
...
```
py/
├── federalregister_sdk.py         -- Main SDK module
