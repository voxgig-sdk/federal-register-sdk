...
from federalregister_sdk.utility import register

# Load features
from federalregister_sdk.feature.base_feature import FederalRegisterBaseFeature
from federalregister_sdk.features import _has_feature, _make_feature
...
class FederalRegisterSDK:
    ...
    def get_utility(self):
        return FederalRegisterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FederalRegisterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Document(self, data=None) -> "DocumentEntity":
        ...
        from federalregister_sdk.entity.document_entity import DocumentEntity
