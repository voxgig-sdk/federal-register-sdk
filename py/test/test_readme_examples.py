# FederalRegister SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FederalRegisterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FederalRegisterSDK(...) and FederalRegisterSDK.test(...) become
#      FederalRegisterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "federalregister_sdk"
_SDK_CLASS = "FederalRegisterSDK"
