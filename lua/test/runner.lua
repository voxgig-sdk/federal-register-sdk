...
function runner.env_override(m)
  local live = runner.getenv("FEDERAL_REGISTER_TEST_LIVE")
  local override = runner.getenv("FEDERAL_REGISTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FEDERAL_REGISTER_TEST_EXPLAIN")
