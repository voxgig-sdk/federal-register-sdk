...
type Args struct {
	Entity string         `json:"entity" jsonschema:"document"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FederalRegisterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "federal-register_list",
		Description: "List records from FederalRegister. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "federal-register_load",
		Description: "Load a single record from FederalRegister. " +
...
func runOp(client *sdk.FederalRegisterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FederalRegisterSDK, name string) (sdk.FederalRegisterEntity, error) {
