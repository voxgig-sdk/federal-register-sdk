// Command FederalRegister-mcp is an MCP server exposing the FederalRegister
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FederalRegister_list  — list records of an entity
//	FederalRegister_load  — load a single record of an entity
//
