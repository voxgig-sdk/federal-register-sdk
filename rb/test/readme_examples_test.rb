...
#      offline in seeded test mode (FederalRegisterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FederalRegister_sdk.rb")
  SDK_CLASS = "FederalRegisterSDK"
