...
class DocumentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FEDERALREGISTER_TEST_DOCUMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def document_basic_setup(extra)
  ...
  entid_env_raw = ENV["FEDERALREGISTER_TEST_DOCUMENT_ENTID"]
