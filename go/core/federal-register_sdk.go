...
type FederalRegisterSDK struct {
	Mode     string
...
func (sdk *FederalRegisterSDK) OptionsMap() map[string]any {
...
func (sdk *FederalRegisterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FederalRegisterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FederalRegisterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FederalRegisterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FederalRegisterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FederalRegisterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FederalRegisterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FederalRegisterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FederalRegisterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FederalRegisterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FederalRegisterSDK {
	...
	sdk := NewFederalRegisterSDK(sdkopts)
	sdk.Mode = "test"
