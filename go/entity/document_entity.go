...
import (
	...
	vs "github.com/voxgig-sdk/federal-register-sdk/go/utility/struct"
)

type DocumentEntity struct {
	name    string
	client  *core.FederalRegisterSDK
...
func NewDocumentEntity(client *core.FederalRegisterSDK, entopts map[string]any) *DocumentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DocumentEntity) GetName() string { return e.name }
...
func (e *DocumentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DocumentEntity) Deleted() bool {
	return e.deleted
}


func (e *DocumentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDocumentEntity(e.client, opts)
}

func (e *DocumentEntity) Data(args ...any) any {
...
func (e *DocumentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Document; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DocumentEntity) DataTyped(data ...Document) Document {
	if len(data) > 0 {
		return typedFrom[Document](e.Data(asMap(data[0])))
	}
	return typedFrom[Document](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Document (all fields
// optional at the wire level).
func (e *DocumentEntity) MatchTyped(match ...Document) Document {
	if len(match) > 0 {
		return typedFrom[Document](e.Match(asMap(match[0])))
	}
	return typedFrom[Document](e.Match())
}
...
func (e *DocumentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DocumentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DocumentLoadMatch and returns an Document. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DocumentEntity) LoadTyped(reqmatch DocumentLoadMatch, ctrl map[string]any) (Document, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Document{}, err
	}
	return typedFrom[Document](res), nil
}




func (e *DocumentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DocumentListMatch and returns []Document. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DocumentEntity) ListTyped(reqmatch DocumentListMatch, ctrl map[string]any) ([]Document, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Document](res), nil
}



func (e *DocumentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DocumentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DocumentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DocumentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
