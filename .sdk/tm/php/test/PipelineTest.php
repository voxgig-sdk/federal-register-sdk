...
// FederalRegister SDK pipeline test
//
...
{
    private static function utility(): FederalRegisterUtility
    {
        return new FederalRegisterUtility();
    }
    ...
    private static function ctx(array $over = []): FederalRegisterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FederalRegisterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FederalRegisterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FederalRegisterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FederalRegisterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FederalRegisterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FederalRegisterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FederalRegisterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FederalRegisterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FederalRegisterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FederalRegisterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FederalRegisterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FederalRegisterResponse([]),
            'result' => new FederalRegisterResult([]),
        ]);
        [, $err] = FederalRegisterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec([]),
            'response' => null,
            'result' => new FederalRegisterResult([]),
        ]);
        [, $err] = FederalRegisterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec(['step' => 's']),
            'response' => new FederalRegisterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FederalRegisterResult([]),
        ]);
        [, $err] = FederalRegisterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec(['step' => 's']),
            'response' => new FederalRegisterResponse(self::resp(200, ['v' => 1])),
            'result' => new FederalRegisterResult([]),
        ]);
        [, $err] = FederalRegisterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec(['step' => 's']),
            'response' => new FederalRegisterResponse(self::resp(200, ['v' => 2])),
            'result' => new FederalRegisterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FederalRegisterMakeResponse::call($ctx);
    ...
    {
        $preset = new FederalRegisterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec([]),
            'response' => new FederalRegisterResponse([]),
            'result' => new FederalRegisterResult([]),
        ...
        [$got, $err] = FederalRegisterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FederalRegisterResult([])]);
        [, $err] = FederalRegisterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FederalRegisterSpec([]), 'result' => null]);
        [, $err] = FederalRegisterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FederalRegisterSpec(['step' => 's']),
            'result' => new FederalRegisterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FederalRegisterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FederalRegisterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FederalRegisterSpec(['step' => 's']),
            'result' => new FederalRegisterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FederalRegisterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FederalRegisterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FederalRegisterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FederalRegisterSpec([]),
            'result' => new FederalRegisterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FederalRegisterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FederalRegisterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FederalRegisterError('boom', 'boom');
        $utility->fetcher = function (FederalRegisterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FederalRegisterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FederalRegisterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FederalRegisterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FederalRegisterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FederalRegisterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FederalRegisterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FederalRegisterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FederalRegisterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FederalRegisterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FederalRegisterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FederalRegisterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FederalRegisterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FederalRegisterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FederalRegisterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FederalRegisterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FederalRegisterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FederalRegisterResult(['ok' => false])]);
        $this->expectException(FederalRegisterError::class);
        FederalRegisterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FederalRegisterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FederalRegisterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FederalRegisterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FederalRegisterBaseFeature();
        $b = new FederalRegisterBaseFeature();
        FederalRegisterFeatureAdd::call($ctx, $a);
        FederalRegisterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FederalRegisterBaseFeature
    {
        $f = new FederalRegisterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FederalRegisterFeatureAdd::call($ctx, self::named_feature('a'));
        FederalRegisterFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FederalRegisterFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FederalRegisterFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FederalRegisterFeatureAdd::call($ctx, $replace);
        ...
        FederalRegisterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FederalRegisterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FederalRegisterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FederalRegisterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FederalRegisterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FederalRegisterResponse(['headers' => null]),
            'result' => new FederalRegisterResult([]),
        ]);
        FederalRegisterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FederalRegisterResultBody::call($ctx);
