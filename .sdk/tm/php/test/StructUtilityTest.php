...
// FederalRegister SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FederalRegisterOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FederalRegisterOmni::structfix($now, Struct::undef()))
                        !== json_encode(FederalRegisterOmni::structfix($val, Struct::undef()))) {
