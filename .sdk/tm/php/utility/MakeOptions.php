...
// FederalRegister SDK utility: make_options

class FederalRegisterMakeOptions
{
    ...
    public static function call(FederalRegisterContext $ctx): array
    {
        ...
        //
        // `FederalRegisterSchema::optspec()` is built from the model:
        ...
        $optspec = FederalRegisterSchema::optspec();
