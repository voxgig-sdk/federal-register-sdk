...
// FederalRegister SDK utility: result_basic

class FederalRegisterResultBasic
{
    public static function call(FederalRegisterContext $ctx): ?FederalRegisterResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FederalRegisterError) ? $result->err->msg : (string)$result->err;
