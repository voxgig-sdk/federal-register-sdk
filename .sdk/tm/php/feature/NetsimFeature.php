...
// FederalRegister SDK netsim feature
...
class FederalRegisterNetsimFeature extends FederalRegisterBaseFeature
{
    ...
    private function _simulate(FederalRegisterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FederalRegisterContext $ctx, array $applied): void
    {
        $client = $this->client;
