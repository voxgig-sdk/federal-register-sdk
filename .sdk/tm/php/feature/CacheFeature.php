...
// FederalRegister SDK cache feature
...
class FederalRegisterCacheFeature extends FederalRegisterBaseFeature
{
    ...
    private function _through(FederalRegisterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
