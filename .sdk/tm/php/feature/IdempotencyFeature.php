...
// FederalRegister SDK idempotency feature
...
class FederalRegisterIdempotencyFeature extends FederalRegisterBaseFeature
{
    ...
    private function _mutating(FederalRegisterContext $ctx): bool
    {
