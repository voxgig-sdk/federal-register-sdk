...
// FederalRegister SDK ratelimit feature
...
class FederalRegisterRatelimitFeature extends FederalRegisterBaseFeature
{
    ...
    private function _acquire(FederalRegisterContext $ctx): void
    {
    ...
    private function _track(FederalRegisterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
