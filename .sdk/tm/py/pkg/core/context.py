...
from projectname_sdk.core.control import FederalRegisterControl
...
class FederalRegisterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FederalRegisterControl()
        ...
        if isinstance(sp, FederalRegisterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FederalRegisterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FederalRegisterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FederalRegisterOperation({})
    ...
    def make_error(self, code, msg):
        return FederalRegisterError(code, msg, self)
