...
|---|---|---|
| `ts/` | @voxgig-sdk/federal-register-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/federal-register-sdk \
      --repository voxgig-sdk/federal-register-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/federal-register-sdk` shows it, and
`npm trust revoke @voxgig-sdk/federal-register-sdk --id=<id>` removes it.
