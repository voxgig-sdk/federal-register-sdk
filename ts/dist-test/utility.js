...
function envOverride(m) {
    if ('TRUE' === process.env.FEDERAL_REGISTER_TEST_LIVE ||
        'TRUE' === process.env.FEDERAL_REGISTER_TEST_OVERRIDE) {
    ...
    m.FEDERAL_REGISTER_TEST_EXPLAIN = process.env.FEDERAL_REGISTER_TEST_EXPLAIN || m.FEDERAL_REGISTER_TEST_EXPLAIN;
    return m;
}
