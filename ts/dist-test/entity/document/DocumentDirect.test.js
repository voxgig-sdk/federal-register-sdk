...
(0, node_test_1.describe)('DocumentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FederalRegisterSDK({
    ...
    (0, node_test_1.test)('direct-load-document', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-document', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-document', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-document', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.FEDERAL_REGISTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FederalRegisterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FEDERAL_REGISTER_TEST_DOCUMENT_ENTID'];
    ...
    const client = new __1.FederalRegisterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DocumentDirect.test.js.map